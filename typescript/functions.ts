...
const get_Posts = async (url: string): Promise<void> =>{
...
function firstElement<ObjectShape>(arr: ObjectShape[],key:number,newKeyValue:ObjectShape): ObjectShape[] {
    let result: ObjectShape[] = [];
